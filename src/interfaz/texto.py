...
class Texto:
    def __init__(self, x, y, fuente=FUENTE_PRINCIPAL, grueso=False, tamaniof=TF_NORMAL, bg=NEGRO, colort=BLANCO, escala=ESCALA_NORMAL, m=None, oculto=False, centrado=True, dinamico=True):
        self.x, self.y = x, y
