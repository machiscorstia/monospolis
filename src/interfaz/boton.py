...
class Boton:
    def __init__(self, x, y, fuente=FUENTE_PRINCIPAL, tamaniof=TF_NORMAL, grueso=False, colort=BLANCO, bg=NEGRO, escala=ESCALA_NORMAL, m=None, dinamico=False, input=False, acciones=False):
        self.x, self.y = x, y
